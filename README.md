...
app/
├── Controllers/
│   ├── Api/ProductController.php   # RESTful API
│   ├── Auth.php                    # Authentication
│   ├── Customers.php               # Customer module
│   ├── Home.php                    # Dashboard
│   ├── Inventory.php               # Stock ledger
│   ├── Pos.php                     # Point of Sale
│   ├── Products.php                # Product management
│   ├── PurchaseOrders.php          # Purchase orders
...
│   └── Seeds/
│       └── MainSeeder.php          # Main database seeder
└── Filters/
├── Authentication.php          # Login filter
├── Authorization.php           # Role-based access filter
└── BearerToken.php             # API token filter